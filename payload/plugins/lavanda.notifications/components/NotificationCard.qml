...
BorderSurface {
  ...
  readonly property color dimColor: "#A69BB8"
  readonly property color bodyColor: "#D6CFDF"
  readonly property color accentColor: urgency === 2 ? Color.urgent : (urgency === 0 ? dimColor : "#B4A1F5")
  readonly property var cardBorderSpec: Border.flat(urgency === 2 ? Color.urgent : Qt.rgba(0.706, 0.631, 0.961, 0.28), Math.max(1, Style.space(1)))
  ...
  ColumnLayout {
    ...
    RowLayout {
      ...
      Layout.topMargin: root.singleLineToast ? Style.space(9) : Style.space(12)
      Layout.bottomMargin: root.singleLineToast ? Style.space(9) : Style.space(12)
      spacing: root.collapseRedundantIcon ? 0 : (root.compactGlyph ? Style.space(10) : Style.space(14))
  ...
  Item {
    ...
    Text {
      anchors.centerIn: parent
      text: "✕"
      color: closeArea.containsMouse ? "#F2EFFA" : root.dimColor
