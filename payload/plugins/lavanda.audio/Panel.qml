...
Panel {
  ...
  readonly property string toggleHint: anyAudible ? "Silenciar" : "Activar sonido"
  ...
  function outputVolumeName(volume, muted) {
    var label = Model.outputVolumeName(volume, muted)
    var labels = { "Muted": "Silenciado", "Silenced": "Sin volumen", "Concert hall": "Volumen máximo", "Party mode": "Volumen muy alto", "Cranked up": "Volumen alto", "Steady groove": "Volumen medio", "Easy listening": "Sonido suave", "Murmur": "Volumen bajo", "Whisper": "Muy suave" }
