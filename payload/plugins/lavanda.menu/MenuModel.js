// Spanish UI labels; application and product names keep their original names.
var spanishLabels = {
  "Apps": "Aplicaciones",
  "Learn": "Aprender",
  "Trigger": "Acciones",
  ...
  "Stop Screenrecording": "Detener grabación",
  "Screenrecord": "Grabar pantalla",
  "Text": "Texto",
  "QR Code": "Código QR",
  "With no audio": "Sin audio",
  "With desktop audio": "Con audio del escritorio",
  "With desktop + microphone audio": "Con audio y micrófono",
  "With desktop + microphone audio + webcam": "Con audio, micrófono y cámara",
  "Transcode": "Convertir archivos",
  "Share": "Compartir",
  "Toggle": "Activar o desactivar",
  "Speed Test": "Pruebas de velocidad",
  "Laptop Display": "Pantalla del portátil",
  "Mirror Display": "Duplicar pantalla",
  "Hybrid GPU": "GPU híbrida",
  "Touchpad": "Panel táctil",
  "Touchpad Haptics": "Respuesta háptica",
  "Touchscreen": "Pantalla táctil",
  "low": "Baja",
  "mid": "Media",
  "high": "Alta",
  "Set one": "Crear recordatorio",
  ...
  "Folder": "Carpeta",
  "Receive": "Recibir",
  "Stay Awake": "Mantener despierto",
  "Notifications": "Notificaciones",
  "Crash Capture": "Registro de fallos",
  "Nightlight": "Luz nocturna",
  "Battery Percentage": "Porcentaje de batería",
  "Network Speed Test": "Velocidad de red",
  "Disk Speed Test": "Velocidad del disco",
  "Theme": "Tema",
  "Background": "Fondo de pantalla",
  "Unlock": "Desbloqueo",
  "Font": "Tipografía",
  "Menu Bar": "Barra superior",
  "Window Gaps": "Espacio entre ventanas",
  "Workspace Layout": "Distribución de ventanas",
  "1-Window Ratio": "Proporción de ventana única",
  ...
  "Clone Plugin": "Clonar complemento",
  "Remove Plugin": "Eliminar complemento",
  "Security": "Seguridad",
  "Config": "Archivos de configuración",
  "Fingerprint": "Huella dactilar",
  "Passwordless Sudo": "Sudo sin contraseña",
  "Sudoless Docker": "Docker sin sudo",
  "Direct Boot": "Inicio directo",
  "Reset Computer": "Restablecer equipo",
  "Drive Encryption": "Cifrado del disco",
  "User": "Usuario",
  "Trackpad": "Panel táctil",
  "Custom": "Personalizado",
  "Package": "Paquete",
  "Web App": "Aplicación web",
  "TUI": "Aplicación de terminal",
  "Service": "Servicio",
  "Services": "Servicios",
  "Development": "Desarrollo",
  "Gaming": "Juegos",
  "AI": "Inteligencia artificial",
  "Preinstalls": "Aplicaciones preinstaladas",
  "Dictation": "Dictado",
  "Channel": "Canal",
  "Extra Themes": "Temas adicionales",
  "Process": "Procesos",
  "Password": "Contraseña",
  ...
  "Chromium Account": "Cuenta de Chromium",
  "Xbox Controllers": "Mandos Xbox",
  "Xbox Controllers (󰂯)": "Mandos Xbox (󰂯)"
};
...
function normalizeItem(id, raw) {
  ...
  var originalLabel = value.label || id
  var localizedLabel = spanishLabels[originalLabel] || originalLabel
  if (localizedLabel !== originalLabel && aliases.indexOf(originalLabel) === -1) aliases.push(originalLabel)
  var plainLabel = localizedLabel.toLowerCase().replace(/[áàäâ]/g, "a").replace(/[éèëê]/g, "e").replace(/[íìïî]/g, "i").replace(/[óòöô]/g, "o").replace(/[úùüû]/g, "u").replace(/ñ/g, "n")
  if (plainLabel !== localizedLabel.toLowerCase() && aliases.indexOf(plainLabel) === -1) aliases.push(plainLabel)
  ...
  return {
    ...
    title: spanishLabels[value.title] || value.title || "",
    target: value.target || "",
...
function mergeMenuSources(defaultItems, userItems) {
  ...
  if (!nextItems.root) {
    nextItems.root = { id: "root", parent: "", kind: "menu", icon: "", iconFont: "", label: "Buscar", title: "", target: "", description: "", aliases: [], when: "", checked: "", action: "", provider: "" }
