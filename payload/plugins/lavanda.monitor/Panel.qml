...
Panel {
  ...
  function brightnessName(percent) {
    var label = Model.brightnessName(percent)
    var labels = { "Sun blast": "Brillo máximo", "Solar flare": "Muy luminoso", "Golden hour": "Luz cálida", "Even day": "Luz equilibrada", "Soft glow": "Luz suave", "Lamp light": "Luz tenue", "Candlelit": "Muy tenue", "Night owl": "Luz nocturna" }
              ...
              Text {
                ...
                text: {
                  if (root.brightnessAvailable) {
                    return root.brightnessName(brightnessSlider.dragging ? brightnessSlider.liveValue : root.brightnessPercent)
                  }
                  return "Brillo fijo"
                }
  ...
  component MonitorRow: CursorSurface {
    ...
    Row {
      ...
      Text {
        textFormat: Text.PlainText
        text: monitorRow.display.name + (monitorRow.display.focused ? " · seleccionada" : "")
        color: root.textColor
        font.family: root.uiFont
