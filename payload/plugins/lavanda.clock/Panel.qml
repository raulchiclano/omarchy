...
Panel {
  ...
  readonly property color contentForeground: "#F2EFFA"
  readonly property string contentFontFamily: "Adwaita Sans"

  readonly property int cellWidth: Style.space(40)
  ...
  function weekdayLabel(weekday) {
    return String(labelLocale.dayName(weekday, Locale.ShortFormat)).replace(/\.$/, "")
  }
                  ...
                  Repeater {
                    ...
                    Rectangle {
                      ...
                      Text {
                        ...
                        anchors.centerIn: parent
                        text: modelData.day
                        color: modelData.today ? "#211A35" : (modelData.inMonth ? root.contentForeground : "#787285")
                        font.family: root.contentFontFamily
                        font.pixelSize: 13
          ...
          Item {
            ...
            Item {
              ...
              Text {
                ...
                horizontalAlignment: Text.AlignHCenter
                text: root.labelLocale.toString(root.viewDate, "MMMM yyyy")
                color: "#D4CCE4"
                font.family: root.contentFontFamily
