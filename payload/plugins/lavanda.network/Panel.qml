...
Panel {
  id: root
  readonly property color textColor: "#F2EFFA"
  readonly property color mutedTextColor: "#C9C0D8"
  ...
  // is currently running so it can render "Conectando…" / "Desconectando…" /
  // "Olvidando…". `passwordSsid` is the row currently expanded into
  ...
  readonly property string toggleHint: Networking.wifiEnabled ? "Desactivar Wi-Fi" : "Activar Wi-Fi"
  ...
  readonly property color hoverFill: "#20B4A1F5"
  readonly property color selectedFill: "#33B4A1F5"
  ...
  function runNetworkAction(kind, network, callback) {
    ...
    // "Conectando…" / "Desconectando…" forever.
  ...
  Timer {
    ...
    // while the action is still tracked to show "Contraseña incorrecta" and reopen
      ...
      Item {
        ...
        RowLayout {
          ...
          Button {
            ...
            iconText: "󰓅"
            tooltipText: "Prueba de velocidad"
            foreground: root.textColor
            fontFamily: Style.font.family
            iconSize: Style.font.subtitle * 1.5
            horizontalPadding: Style.space(5)
        ...
        Column {
          ...
          Text {
            ...
            readonly property string title: {
              ...
              return root.info.iface || (root.kind === "disconnected" ? "Desconectado" : "Sin conexión")
            }
          ...
          Text {
            ...
            text: {
              if (root.info.type === "wifi") {
                ...
                if (root.kind === "disconnected") return "Sin conexión"
                return ""
              }
      ...
      Column {
        ...
        GridLayout {
          ...
          DetailValue {
            ...
            color: root.internetPingPacketLoss > 0 ? root.bar.urgent : root.textColor
          }
          InfoLabel { text: "Pérdida" }
          DetailValue {
            text: root.formatPacketLoss(root.internetPingPacketLoss)
            color: root.internetPingPacketLoss > 0 ? root.bar.urgent : root.textColor
          }

          InfoLabel { text: "Recibiendo" }
          ...
          InfoLabel { text: "Dirección IP" }
          DetailValue {
            text: root.info.ip || "--"
            copyable: !!root.info.ip
            tooltipText: "Copiar IP"
          }
          InfoLabel { text: "Puerta de enlace" }
          DetailValue {
            text: root.info.gateway || "--"
            copyable: !!root.info.gateway
            tooltipText: "Copiar puerta de enlace"
          }
        }
      }
      ...
      Column {
        ...
        Item {
          ...
          PanelSectionHeader {
            ...
            color: root.mutedTextColor
            id: bandHeader
            text: root.bandSectionTitle.replace("WI-FI BAND", "Banda Wi-Fi")
            foreground: root.textColor
            fontFamily: root.uiFont
            anchors.left: parent.left
            anchors.verticalCenter: parent.verticalCenter
      ...
      Column {
        ...
        Row {
          ...
          DnsProviderPill {
            provider: "DHCP"
            index: 0
            tooltipText: "Usar DNS automático (DHCP)"
          ...
          DnsProviderPill {
            provider: "Cloudflare"
            index: 1
            tooltipText: "Usar DNS de Cloudflare"
            width: dnsRow.cellWidth
            onClicked: root.setDns(provider)
          }
          ...
          DnsProviderPill {
            provider: "Google"
            index: 2
            tooltipText: "Usar DNS de Google"
            width: dnsRow.cellWidth
            onClicked: root.setDns(provider)
          }
          ...
          DnsProviderPill {
            provider: "Custom"
            index: 3
            tooltipText: "Configurar servidores DNS"
            width: dnsRow.cellWidth
            onClicked: root.setDns(provider)
          }
        }
        ...
        delegate: Item {
          ...
          Column {
            ...
            PanelSectionHeader {
              ...
              text: sectionTitle === "KNOWN NETWORKS" ? "Redes guardadas" : sectionTitle === "OTHER NETWORKS" ? "Otras redes" : sectionTitle
              foreground: root.textColor
              fontFamily: root.uiFont
  ...
  component DnsProviderPill: Button {
    ...
    color: hot ? "#20B4A1F5" : active ? "#33B4A1F5" : "transparent"
    borderSpec: Border.flat(hot ? "#88B4A1F5" : "#47B4A1F5", Math.max(1, Style.space(1)))
    text: provider === "Custom" ? "Manual" : provider
    fontSize: Style.font.bodySmall
    foreground: root.textColor
    fontFamily: root.uiFont
    horizontalPadding: Style.spacing.controlPaddingX
  ...
  component NetworkRow: CursorSurface {
    ...
    readonly property string statusText: {
      ...
      if (isBusy && root.actionKind === "forget") return "Olvidando…"
    ...
    readonly property color statusColor: {
      ...
      if (isBusy) return root.textColor
      if (isConnected) return root.textColor
    ...
    Item {
      ...
      Item {
        ...
        Text {
          ...
          color: row.forgetVisible ? root.bar.urgent : root.mutedTextColor
          font.family: Style.font.family
    ...
    Item {
      ...
      BorderSurface {
        ...
        color: Style.normalFillFor(root.textColor)
        borderSpec: Border.controlSpec("normal", root.textColor, Color.accent)
        radius: Style.cornerRadius
        ...
        Text {
          ...
          text: row.isFailed ? "Contraseña incorrecta" : "Conectando…"
          color: row.isFailed ? root.bar.urgent : root.textColor
          font.family: root.uiFont
          font.pixelSize: Style.space(12)
        }
      }
